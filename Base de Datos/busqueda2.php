...
<?php
function ejecuta_consulta($busca){
	...
	$sql = "select * from productos where NOMBRE_ARTICULO like '%$busca%' ";
...
<body>
<?php
	//Esto sale en local, en servidor desaparece
	$datoBuscar = $_GET["buscar"];

	//La pagina que tiene que llamar, es a ella misma	
	$miPagina = $_SERVER["PHP_SELF"];
	
	if($datoBuscar!=null){
		ejecuta_consulta($datoBuscar);
	}else{
